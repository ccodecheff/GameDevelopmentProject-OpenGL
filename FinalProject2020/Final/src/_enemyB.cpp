...
void _enemyB::drawEnemy2()
{
    ...
    glBindTexture(GL_TEXTURE_2D,EnemyTex2);
...
void _enemyB::placeEnemy2(float x, float y, float z)
{   xPos = x;
    yPos = y;
    zPos = z;
}

void _enemyB::actions()
{ switch(action)
    {
...
void _enemyB::checkCollision(_player* ply)
{
...
void _enemyB::enemyMovement(_player* ply)
{
